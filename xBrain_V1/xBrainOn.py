...
while True:
    ...
    if int(bal) > 0:
        ...
        console.print('[green]Bitcoin Address  [/green]', address, f'TX = {str(bal)}')
        ...
        console.print(
            '[green]Bitcoin Address  [/green] ',
            address,
            f'[yellow]TX = [/yellow]{str(bal)}',
        )
        console.print(
            f'[red] :ScanNumber:  [{count}] [/red][green] Winner: [{str(win)}]---------------------------------------------------------------- [/green]'
        )
